    ...
    return (
      ...
      <View style={styles.flex}>
          ...
          >
            {
              ...
              <TouchableOpacity onPress={() => this.openMap(img.lat,img.lon,img.title)}>
                <Image
                  key={`${index}-${img}`}
                  source={{ uri: img.src }}
                  resizeMode='cover'
                    ...
                    {this.renderDots()}
                      ...
                      <View>
                        <Text style={styles.description}>
                          {img.description.split('').slice(0, 180)}...
        ...
        {/* <View style={[styles.flex, styles.content]}>
          <View style={[styles.flex, styles.contentHeader]}>
            <Image style={[styles.avatar, styles.shadow]} source={{ uri: article.user.avatar }} />
            <Text style={styles.title}>{article.images.title}</Text>
            <View style={[
              styles.row,
              { alignItems: 'center', marginVertical: theme.sizes.margin / 2 }
            ]}>
